 ...
 * org.mockito.BDDMockito.given; import static
 ...
 * "org.springframework.jms" , "org.springframework.jms.core" , "javax.jms" ,
 * "com.fasterxml.jackson" , "org.springframework.data" ,
 ...
 * //@WebMvcTest(ConsumerController.class) public class
 ...
 * 
 * 
 * @Test public void getProductsListViaConsumer() throws Exception { String uri
 * = "/product";
 * 
 * 
 ...
 * 
 * MvcResult mvcResult =
 * this.mockMvc.perform(get("/consume/productList")).andReturn();
 * 
 ...
 * 
 * 
 * //compare API using mock assertEquals("product/ListInventory",
 * viewNameFromResponse);
 * 
 * 
